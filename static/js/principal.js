...
document.addEventListener("DOMContentLoaded", () => {
    ...
    inputBusqueda.addEventListener("input", function () {
        ...
        if (texto.length < 2) {
            return; // no mostrar nada si escribe muy poco
        }
        ...
        filtrados.forEach(alumno => {
            ...
            div.classList.add("opcion-autocomplete");
            div.textContent = alumno.NombreAlumno + " " + alumno.ApellidoAlumno;

            div.addEventListener("click", () => {
                inputBusqueda.value = div.textContent;
